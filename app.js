...
if (!process.env.MONGO_DB_URI) {
    console.error("❌ La variable MONGO_DB_URI no está definida en Railway");
    process.exit(1);
} else {
    console.log("✅ MONGO_DB_URI detectada correctamente");
}
...
// Captura errores globales de promesas no manejadas
